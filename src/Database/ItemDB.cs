...
//         public ItemInfoPoco itemInfo { get; set; }
//         public MarketDataPoco marketData { get; set; } = new List<MarketDataPoco>();
//         public List<RecipePoco> fullRecipes { get; set; } = new List<RecipePoco>();
...
//                 try
//                 {
//                     using (GilGoblinDbContext context = DatabaseAccess.getContext())
//                     {
//                         exists = context.data
