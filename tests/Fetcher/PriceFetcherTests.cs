...
public class PriceBulkFetcherTests : FetcherTests
{
    ...
    //     _handler
    //         .When(GetMarketableItemIdsAsyncUrl)
    //         .Respond(HttpStatusCode.OK, ContentType, JsonSerializer.Serialize(idList));
    //
    //     var result = await _marketableItemIdsFetcher.GetMarketableItemIdsAsync();
    //
    //     Assert.Multiple(() =>
    //     {
    //         Assert.That(result, Is.Not.Null);
    ...
    //     _handler
    //         .When(GetMarketableItemIdsAsyncUrl)
    //         .Respond(HttpStatusCode.NotFound, ContentType, JsonSerializer.Serialize("{}"));
    //
    //     var result = await _marketableItemIdsFetcher.GetMarketableItemIdsAsync();
    //
    //     Assert.That(result, Is.Empty);
    ...
    // [Test]
    // public async Task
    //     GivenWeCallGetMarketableItemIdsAsync_WhenTheResponseIsStatusCodeIsSuccessful_ThenWeReturnAnIDList()
    // {
    //     var idList = GetMultipleNewPocos().Select(i => i.ItemId);
    //     _handler
    //         .When(GetMarketableItemIdsAsyncUrl)
    ...
    // {
    //     _handler.When(GetMarketableItemIdsAsyncUrl)
    //         .Respond(HttpStatusCode.OK, ContentType, JsonSerializer.Serialize(new List<int>()));
    //
    ...
    private static string GetMarketableItemIdsAsyncUrl =>
