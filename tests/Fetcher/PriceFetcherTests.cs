...
public class PriceAggregatedFetcherTests : FetcherTests
{
    ...
    private static string FetchPricesAsyncUrl =>
        "https://universalis.app/api/v2/34/4211,4222?listings=0&fields=itemID,worldID,currentAveragePrice," +
        "currentAveragePriceNQ,currentAveragePriceHQ,averagePrice,averagePriceNQ,averagePriceHQ,lastUploadTime";
