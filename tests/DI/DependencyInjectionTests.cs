...
public class DependencyInjectionTests
{
    ...
    [TestCase(typeof(CraftRepository))]
    [TestCase(typeof(IRecipeGrocer))]
    [TestCase(typeof(RecipeGrocer))]
    [TestCase(typeof(ICraftingCalculator))]
    [TestCase(typeof(CraftingCalculator))]
    [TestCase(typeof(IPriceDataFetcher))]
    [TestCase(typeof(GilGoblinDatabase))]
    [TestCase(typeof(PriceRepository))]
    [TestCase(typeof(ItemRepository))]
    [TestCase(typeof(RecipeRepository))]
    [TestCase(typeof(ISqlLiteDatabaseConnector))]
    [TestCase(typeof(GilGoblinDatabaseConnector))]
